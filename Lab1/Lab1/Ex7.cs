...
namespace Lab1
{
    public partial class Ex7 : Form
    {
        ...
        private void StringScoresToArray(ref double[]? scores, ref string studentName)
        {
            ...
            studentName = inputStrings[0].Trim();
            scores = new double[inputStrings.Length - 1]; 
            double num;
        ...
        private void labelInputScores_Click(object sender, EventArgs e)
        {
        ...
        private void labelPassed_Click(object sender, EventArgs e)
        {
        ...
        private void textBoxFail_TextChanged(object sender, EventArgs e)
        {
